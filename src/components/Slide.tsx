...
const Slide = (props: Props) => {
    const img1 = process.env.PUBLIC_URL + '/img/banner_img_01.jpg';
    const img2 = process.env.PUBLIC_URL + '/img/banner_img_02.jpg';
    const img3 = process.env.PUBLIC_URL + '/img/banner_img_03.jpg';
  return (
    <div>
